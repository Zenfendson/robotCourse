...
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { ultrasonic_sig_tri_io }]; #IO_L5N_T0_34 Sch=ar[5]
...
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { B }]; #IO_L21N_T3_DQS_34 Sch=ar[9]
