...
wire   [0:0] exitcond2_i_fu_333_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond2_i_fu_333_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_condition_pp1_exit_iter0_state5) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond2_i_fu_333_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_344_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        tmp_5_reg_450 <= {{ap_phi_mux_p_Val2_s_phi_fu_264_p4[15:8]}};
        tmp_6_reg_455 <= {{ap_phi_mux_p_Val2_s_phi_fu_264_p4[23:16]}};
...
always @ (*) begin
    if (((exitcond2_i_fu_333_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_i_reg_296 == 1'd0) & (1'b1 == ap_CS_fsm_state8)) | ((brmerge_i_fu_358_p2 == 1'd0) & (exitcond_i_fu_344_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
        in_stream_TDATA_blk_n = AXI_video_strm_V_data_V_0_state[1'd0];
    end else begin
...
assign AXI_video_strm_V_data_V_0_vld_in = in_stream_TVALID;

assign AXI_video_strm_V_data_V_0_vld_out = AXI_video_strm_V_data_V_0_state[1'd0];

assign AXI_video_strm_V_dest_V_0_vld_in = in_stream_TVALID;
...
assign AXI_video_strm_V_last_V_0_vld_in = in_stream_TVALID;
...
assign AXI_video_strm_V_user_V_0_vld_in = in_stream_TVALID;
...
assign exitcond2_i_fu_333_p2 = ((t_V_reg_191 == rows_V_reg_393) ? 1'b1 : 1'b0);

assign exitcond_i_fu_344_p2 = ((t_V_2_reg_224 == cols_V_reg_398) ? 1'b1 : 1'b0);
...
assign img_data_stream_1_V_din = tmp_5_reg_450;

assign img_data_stream_2_V_din = tmp_6_reg_455;

assign img_rows_V_out_din = img_rows_V_dout;

assign in_stream_TREADY = AXI_video_strm_V_dest_V_0_state[1'd1];

assign j_V_fu_349_p2 = (t_V_2_reg_224 + 32'd1);
