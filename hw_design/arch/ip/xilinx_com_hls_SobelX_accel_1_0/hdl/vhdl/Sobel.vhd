...
architecture behav of Sobel is 
    ...
    signal p_src_rows_V_read_reg_52 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal p_src_cols_V_read_reg_57 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    port map (
        ...
        p_src_rows_V_read => p_src_rows_V_read_reg_52,
        p_src_cols_V_read => p_src_cols_V_read_reg_57,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((real_start = ap_const_logic_0) or (p_src_cols_V_empty_n = ap_const_logic_0) or (p_src_rows_V_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                p_src_cols_V_read_reg_57 <= p_src_cols_V_dout;
                p_src_rows_V_read_reg_52 <= p_src_rows_V_dout;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, p_src_rows_V_empty_n, p_src_cols_V_empty_n, grp_Filter2D_fu_40_ap_done, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
    ...
    internal_ap_ready_assign_proc : process(grp_Filter2D_fu_40_ap_done, ap_CS_fsm_state2)
    begin
        if (((grp_Filter2D_fu_40_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
