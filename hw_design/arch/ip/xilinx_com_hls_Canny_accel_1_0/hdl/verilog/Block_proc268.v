...
output  [10:0] img_in_rows_V_out_din;
input   img_in_rows_V_out_full_n;
output   img_in_rows_V_out_write;
output  [11:0] img_in_cols_V_out_din;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((real_start == 1'b0) | (high_threshold_out_full_n == 1'b0) | (low_threshold_out_full_n == 1'b0) | (img_in_cols_V_out_full_n == 1'b0) | (img_in_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (high_threshold_out_full_n == 1'b0) | (low_threshold_out_full_n == 1'b0) | (img_in_cols_V_out_full_n == 1'b0) | (img_in_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (high_threshold_out_full_n == 1'b0) | (low_threshold_out_full_n == 1'b0) | (img_in_cols_V_out_full_n == 1'b0) | (img_in_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1));
end
...
assign img_in_cols_V_out_din = 12'd1280;

assign img_in_rows_V_out_din = 11'd720;

assign low_threshold_out_din = low_threshold;

assign start_out = real_start;

endmodule //Block_proc268
