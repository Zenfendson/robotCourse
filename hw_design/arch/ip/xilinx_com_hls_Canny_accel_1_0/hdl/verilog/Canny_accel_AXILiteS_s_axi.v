...
// ==============================================================
`timescale 1ns/1ps
module Canny_accel_AXILiteS_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER                   = 5'h08,
    ADDR_ISR                   = 5'h0c,
    ADDR_LOW_THRESHOLD_DATA_0  = 5'h10,
    ADDR_LOW_THRESHOLD_CTRL    = 5'h14,
    ADDR_HIGH_THRESHOLD_DATA_0 = 5'h18,
    ADDR_HIGH_THRESHOLD_CTRL   = 5'h1c,
    WRIDLE                     = 2'd0,
    WRDATA                     = 2'd1,
    WRRESP                     = 2'd2,
    WRRESET                    = 2'd3,
