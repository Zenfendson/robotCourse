...
entity Canny_accel_AXILiteS_s_axi is
generic (
...
end entity Canny_accel_AXILiteS_s_axi;
...
architecture behave of Canny_accel_AXILiteS_s_axi is
    ...
    constant ADDR_LOW_THRESHOLD_DATA_0  : INTEGER := 16#10#;
    constant ADDR_LOW_THRESHOLD_CTRL    : INTEGER := 16#14#;
    constant ADDR_HIGH_THRESHOLD_DATA_0 : INTEGER := 16#18#;
    constant ADDR_HIGH_THRESHOLD_CTRL   : INTEGER := 16#1c#;
